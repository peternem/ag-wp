<?php
if (!class_exists('Slickr_Flickr_News')) {
 class Slickr_Flickr_News {
    const SCRIPT_VAR = 'slickr_flickr_news';
    const HANDLE = 'slickr-flickr-news';
    const RESULTS = 'slickr-flickr-news-feed';

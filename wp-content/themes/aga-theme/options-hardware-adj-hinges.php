...
<?php endif; ?>
<?php
$acf_option = 'cv_adj_hinge_options';
$acf_label = 'cv_adj_hinge_label';
if( have_rows($acf_option) ): ?>
<!-- <?php echo $acf_option;?> -->
<div class="post-inner-content aga-row row options">
	<div id="<?php echo $acf_option;?>" class="col-md-12 type">
		...
		<div class="row">
			...
			<div class="col-md-4">
					...
					if(get_field('cv_adj_hinge_copy')) {
						echo '<p class="lead">' . get_field('cv_adj_hinge_copy') . '</p>';
					}
					?>
			</div>
		</div>

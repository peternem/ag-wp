...
<div class="post-inner-content aga-row row">
	...
	<article class="col-lg-6">
		<?php
		$elite_sd_col_a_docs = 'elite_sd_col_a_docs';
		$elite_ssd_col_a_label = 'elite_ssd_col_a_label';

		if(get_field($elite_ssd_col_a_label)) {
			echo '<h3>' . get_field($elite_ssd_col_a_label) . '</h3>';
		}
	...
	<article class="col-lg-6">
		<?php
		$elite_sd_col_b_docs = 'elite_sd_col_b_docs';
		$elite_ssd_col_b_label = 'elite_ssd_col_b_label';

		if(get_field($elite_ssd_col_b_label)) {
			echo '<h3>' . get_field($elite_ssd_col_b_label) . '</h3>';
		}

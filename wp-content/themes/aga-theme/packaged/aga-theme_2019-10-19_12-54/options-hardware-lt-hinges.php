<?php 
$acf_option = 'light_duty_hinge_options';
$acf_label = 'light_duty_hinge_label';
if( have_rows($acf_option) ): ?>
    <div class="post-inner-content aga-row row options">
		<!-- light_duty_hinge_options -->
		<div id="light_duty_hinge" class="col-md-12 type">
			<div class="row">
				<div class="col-md-12">
					<?php
			...
			<div class="col-md-4">
				...
				if(get_field('light_duty_hinge_copy')) {
					echo '<p class="lead">' . get_field('light_duty_hinge_copy') . '</p>';
				}
				?>
			</div>
		</div>

...
<!-- 		</div> -->
		<div class="nav-links aga-row row">
			<?php
				previous_post_link( '<div class="nav-previous col-sm-6 col-md-6 col-lg-6">%link</div>', _x( '<i class="fa fa-chevron-left"></i> %title', 'Previous post link', 'sparkling'),true );
				next_post_link(     '<div class="nav-next col-sm-6 col-md-6 col-lg-6 col-md-offset-6">%link</div>',     _x( '%title <i class="fa fa-chevron-right"></i>', 'Next post link', 'sparkling' ),true );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
